<template>
  <div class="new">
    <el-card>
    <Buttons :btns="newBtn" @outclick="newClick">
      <template v-slot:newadd>
      ...
      <template v-slot:newdelete>
        <el-dialog title="所选新品ID" :visible.sync="visibleTwo" width="400px">
    ...
    <Tables :chartData="newCharts" :address="'/api/indexConfigs'" :paramsData="newParam" @outselection="newSelection">
